...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?= $cpath ?>scripts/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="<?= $cpath ?>scripts/bootstrap.min.js" ></script>
    <script type="text/javascript" src="<?= $cpath ?>scripts/plugins.js" ></script>
